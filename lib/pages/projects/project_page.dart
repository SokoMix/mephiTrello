...
class _ProjectPageState extends State<ProjectPage> {
  final _projectManagerProvider = GetIt.I.get<ChangeNotifierProvider<ProjectManager>>();
                        ...
                        child: SingleChildScrollView(
                          ...
                          children: [
                            ...
                            IconButton(
                                onPressed: () {
                                  setState(() {
                                    void deleteIdField(TextEditingController edt) {
                                        final ind = _controllersPerformers.indexOf(edt);
                                    ...
                                    final ctrl = TextEditingController(text: 'Введите id');
                            ...
                            Consumer(
                              builder: (context, ref, _) {
                                return TextButton(
                                    onPressed: (){
                                      ref.watch(_projectManagerProvider).createProject(
                                          _nameCtrl.text,
                                          performers: _controllersPerformers.map((e) => e.text).toList(),
                                      );
